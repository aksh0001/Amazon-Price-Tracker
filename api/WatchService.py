...
class WatchService(object):
    def __init__(self, product: Product, creds: EmailCredentials):
        ...
        self.conv_price = Decimal(price[1:].strip())
    ...
    @staticmethod
    def query_user_agent_headers() -> str:
        header = input("Please enter your user agent header. This can be found by searching 'what's my user agent': ")
        return header
